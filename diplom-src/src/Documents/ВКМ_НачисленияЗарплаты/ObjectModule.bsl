...
Процедура ДобавитьЗаписиПроцентНДФЛ()
	...
	|	ВКМ_НачисленияЗарплатыВКМ_ОсновныеНачисления.ВКМ_Подразделение
	|ИЗ
	...
	|
	|ВЫБРАТЬ
	|	ВКМ_НачисленияЗарплатыВКМ_ДополнительныеНачисления.ВКМ_Сотрудник,
	|	ВКМ_НачисленияЗарплатыВКМ_ДополнительныеНачисления.ВКМ_Подразделение
	|ИЗ
...
Процедура РассчитатьПроцентНДФЛ()
	...
	|	0 КАК БазаДоп,
	|	ЕСТЬNULL(ВКМ_УдержанияБазаВКМ_ОсновныеНачисления.ВКМ_РезультатБаза, 0) КАК БазаОсн,
	...
	|	ЕСТЬNULL(ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.ВКМ_РезультатБаза, 0),
	|	0,
	|	NULL
	|ИЗ
	|	РегистрРасчета.ВКМ_Удержания КАК ВКМ_Удержания
...
Процедура СформироватьВзаиморасчетыССотрудниками()
	...
	|	ВКМ_НачисленияЗарплатыВКМ_ОсновныеНачисления.ВКМ_Подразделение КАК ВКМ_Подразделение,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_Данные.ВКМ_Сотрудник КАК ВКМ_Сотрудник,
	|	ВТ_Данные.ВКМ_Подразделение КАК ВКМ_Подразделение,
	|	СУММА(ЕСТЬNULL(ВКМ_ОсновныеНачисления.ВКМ_Результат, 0)) КАК ОснНачисления,
	|	0 КАК ДопНачисления,
	|	0 КАК Удержания
	...
	|		ПО ВТ_Данные.ВКМ_Сотрудник = ВКМ_ОсновныеНачисления.ВКМ_Сотрудник
	|		И ВТ_Данные.ВКМ_Подразделение = ВКМ_ОсновныеНачисления.ВКМ_Подразделение
	...
	|	ВТ_Данные.ВКМ_Подразделение,
	|	0,
	|	СУММА(ЕСТЬNULL(ВКМ_ДополнительныеНачисления.ВКМ_Результат, 0)),
	|	0
	|ИЗ
	|	ВТ_Данные КАК ВТ_Данные
